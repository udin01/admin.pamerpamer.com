							...
							<div class="header-row pl-4 justify-content-end">
								...
								<ul class="header-social-icons social-icons d-none d-sm-block social-icons-clean m-0">
									...
									@foreach ($sosmed_arr as $keySosmed => $sosmed)
													@if ($sosmed)
											<li class="social-icons-{!! strtolower($keySosmed) !!}"><a href="http://{{ $keySosmed }}.com/{!! $sosmed !!}" target="_blank" title="{!! strtolower($keySosmed) !!}"><i class="fab fa-{!! strtolower($keySosmed) !!} fa-2x"></i></a></li>
													@endif
									@endforeach
								</ul>
