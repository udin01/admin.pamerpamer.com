...
<div class="h-100">
    <form action="{{ route('postLogin') }}" method="post" role="form" class="row h-100">
    
      <div class="col-md-6 p-5 wow fadeIn" data-wow-delay="0.3s" style="background: #ffffffbf url('@foreach ( $sponsor as $kSp => $sp ) {{ env('URL_ENDPOINT').$sp['img_pic'] }} @endforeach') no-repeat; background-size: 200px; background-position: center bottom;border-radius: 25px; margin:auto; padding-bottom: 6em !important;">
        ...
        @csrf
            ...
            <div class="form-group">
                <label>Masukkan No. WhatsApp Anda yang terdaftar atau belum terdaftar, <br/> Sekarang login dan pendaftaran jadi satu</label>
                ...
                <small id="waHelp" class="form-text text-muted text-white">
                    <i>Example: 085111111 atau 85111111 </i>
                </small>
            </div>
             <div class="form-group form-group-nama" style="display:none;">
            ...
            <button href="javascript:void(0);" class="btn btn-primary height-login bg-btn-login w-100" onclick="waKamu();" >Login</button>
