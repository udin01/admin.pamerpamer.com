@extends( $base['thema_lock'].'test_master' )
...
{{-- ############################# --}}
 ...
 <section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
      ...
      <div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
        {{-- <div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="2300" style="background-image: url(img/demos/startup-agency/backgrounds/morphing-bg-1.jpg); background-size: cover; background-position: center;">
        </div> --}}
        ...
        <div class="container mt-0 pt-0">
          <div class="row align-items-center pt-0 mt-0 mt-lg-0 pt-lg-0">
            <div class="col-lg-7">
              {{-- <h1 class="font-weight-bold text-12 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
              {!! $base['description'] !!}
              </h1> --}}
            ...
            <div class="col-lg-5 text-center">
                <figure class="w-100">
                  <img class="w-50" loading="lazy" src="{{ env('URL_ENDPOINT').$baseApp['loader'] }}" alt="Image" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
                </figure>
            </div>
          </div>
        </div>
      </div>
      <div class="spacer mb-0 pb-0 pb-xl-0 mb-xl-0"></div>
  </section>
@endsection
...
<section class="section section-with-shape-divider custom-bg-color-1 border-0 m-0" style="background-image: url({{ env('URL_ENDPOINT').$baseApp['bg_showcase'] }}); background-size: auto; background-position: center;">
                  ...
                  <a href="{{ route('expoproperty_front.event', ['id' => $vEvent->uuid ]) }}">
                      ...
                      <div class="balloon-photo">
												<div class="photo-radius">
													<img oading="lazy" src="{{ env('URL_ENDPOINT').$vEvent->img_pic }}" alt="{{ $vEvent->name }}" class="img-fluid">
												</div>
											</div>
                      @endif
