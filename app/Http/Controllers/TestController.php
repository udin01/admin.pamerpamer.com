...
use App\Models\JobfairJobs as Perumahan;

use App\Models\JobfairJobs as BeautyCategoriProduct;
/*
...
class TestController extends BaseController
{
    ...
    public function getHome(Request $request){
      ...
      return view( $this->thema() . 'test_view', compact( 'base', 'baseApp', 'dev', 'sponsor', 'perumahan', 'event', 'categorie') );
    }
